            ...
            for epoch in range(self.epoch):
                ...
                for index, data in enumerate(self.trainDataLoader[i]):
                    ...
                    if total_batch % 10 == 0:
                        ...
                        dev_micro_f1score, dev_macro_f1score = self.eval(i)
                        improve = ''
                        ...
                        print(
                            "Iter:{:4d} TrainLoss:{:.12f} TrainAcc:{:.5f} DevMicroF1Score:{:.5f} DevMacroF1Score:{:.5f} Improve:{}".format(
                                total_batch, loss.item(), train_acc,  dev_micro_f1score, dev_macro_f1score, improve))
